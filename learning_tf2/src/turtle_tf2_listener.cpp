...
int main(int argc, char** argv) {
    ...
    // crea un publicador de velocidad de la tortuga sobre el topic turtle2/cmd_vel
    /*
     * Twist
     *   Vector3 linear
     *   Vector3 angular
    ...
    while (node.ok()) {
        ...
        try {
            // Obtiene la transformación entre dos marcos: target, source
        ...
        // hace los cálculos necesarios y publica la velocidad de la tortuga 2
